...
namespace Tester
{
    ...
    public class UnitTest
    {
        ...
        {
            Assert.ThrowsException<RoadSmallRadiusException>(() => RoundRoadTools.FoundRound(new NodePoint(sx, sz, sdx, sdz, mode: (Direction)sm), new NodePoint(ex, ez, edx, edz, mode: (Direction)em), r, cw));
        }
